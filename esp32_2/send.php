...
$sql = "SELECT temperature, humidity, vocIndex, timestamp FROM readings WHERE device_id='$device_id' ORDER BY timestamp DESC LIMIT 1";
...
// Debugging: Log values to check if they are being fetched correctly
error_log("Latest reading: Temperature: $temperature, Humidity: $humidity, VOC Index: $vocIndex, Timestamp: $lastReading");
...
// Debugging: Log daily statistics
error_log("Daily statistics: Min Temp: $minTemp, Max Temp: $maxTemp, Avg Temp: $avgTemp, Min Humidity: $minHumidity, Max Humidity: $maxHumidity, Avg Humidity: $avgHumidity");
...
$data = array(
    ...
    'vocIndex' => $vocIndex // Ajout du VOC Index
);

// Debugging: Log the final data array
